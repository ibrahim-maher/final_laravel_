{{-- resources/views/commission/admin/commissions/create.blade.php --}}
...
<div class="flex justify-between items-center mb-6">
    <div>
        <h1 class="text-3xl font-bold text-primary">Create Commission</h1>
        <p class="text-gray-600 mt-1">Set up new commission structure and payout settings</p>
    </div>
...
<form method="POST" action="{{ route('commissions.store') }}" class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border p-6">
        ...
        <div class="mt-4">
            ...
            <textarea name="description" id="description" rows="3"
                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="Enter commission description">{{ old('description') }}</textarea>
            @error('description')
            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
        </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" name="minimum_payout_amount" id="minimum_payout_amount" step="0.01" min="0"
                        value="{{ old('minimum_payout_amount', '10.00') }}"
                        class="w-full pl-8 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        placeholder="10.00">
                </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border p-6">
        ...
        <div id="tier_rules_section" style="display: none;">
            ...
            <textarea name="tier_rules_text" id="tier_rules_text" rows="6"
                ...
                placeholder='[{"min_amount": 0, "max_amount": 100, "rate": 5, "type": "percentage"}, {"min_amount": 100, "max_amount": 500, "rate": 7.5, "type": "percentage"}]'>{{ old('tier_rules_text') }}</textarea>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="applicable_zones_text" id="applicable_zones_text"
                    value="{{ old('applicable_zones_text') }}"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
            <div>
                ...
                <input type="text" name="applicable_vehicle_types_text" id="applicable_vehicle_types_text"
                    value="{{ old('applicable_vehicle_types_text') }}"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            <div>
                ...
                <input type="text" name="excluded_vehicle_types_text" id="excluded_vehicle_types_text"
                    value="{{ old('excluded_vehicle_types_text') }}"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
    ...
    <div class="flex justify-end space-x-4">
        ...
        <button type="submit"
            ...
            <i class="fas fa-save mr-2"></i>Create Commission
        </button>
    </div>
</form>
@endsection
