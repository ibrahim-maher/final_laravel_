{{-- resources/views/foq/admin/foqs/create.blade.php --}}

@extends('admin::layouts.admin')

@section('title', 'Create FOQ')
@section('page-title', 'Create FOQ')
...
<div class="flex justify-between items-center mb-6">
    <div>
        <h1 class="text-3xl font-bold text-primary">Create New FOQ</h1>
        <p class="text-gray-600 mt-1">Add a new frequently offered question to the system</p>
    </div>
...
<div class="bg-white rounded-lg shadow-sm border overflow-hidden">
    <form action="{{ route('foqs.store') }}" method="POST" id="foqForm">
        @csrf
        ...
        <div class="bg-gray-50 px-6 py-3 flex justify-between items-center">
            <div class="flex gap-3">
                <button type="submit" 
                        ...
                        id="submitBtn">
                    <i class="fas fa-save mr-2"></i>Create FOQ
                </button>
                <button type="button" 
                        onclick="saveDraft()"
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        questionInput.addEventListener('input', function() {
            questionCount.textContent = `${this.value.length}/500`;
        });
